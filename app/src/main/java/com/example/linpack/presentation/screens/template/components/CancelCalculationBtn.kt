...
@Composable
fun CancelCalculationBtn(
    enabled: Boolean,
    onClick: () -> Unit,
    modifier: Modifier = Modifier,
) {
    ButtonText(
        text = stringResource(id = R.string.stopCalculation),
        modifier = modifier
...
@Preview
@Composable
private fun CancelCalculationBtnPreview() {
    AppTheme {
...
@Preview
@Composable
private fun CancelCalculationBtnDisabledPreview() {
    AppTheme {
        CancelCalculationBtn(
            enabled = false,
            onClick = {},
