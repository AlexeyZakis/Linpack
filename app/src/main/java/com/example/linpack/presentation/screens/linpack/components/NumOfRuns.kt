...
fun NumOfRuns(
    numOfRuns: Int,
    onNumOfRunsChange: (Float) -> Unit,
    modifier: Modifier = Modifier,
) {
    ValueSlider(
        valueName = stringResource(R.string.numOfRuns),
        value = numOfRuns.toFloat(),
        minValue = Constants.NUM_OF_RUNS_MIN.toFloat(),
        maxValue = Constants.NUM_OF_RUNS_MAX.toFloat(),
        ...
        onValueChange = onNumOfRunsChange,
